...
std::map<int, std::string> streamNameList = {
        ...
        {STREAM_PROCESSID, "STREAM_PROCESSID"},
        {STREAM_PROCESSINFO, "STREAM_PROCESSINFO"},
        {STREAM_PROCESSFILEINFO, "STREAM_PROCESSFILEINFO"},
        {STREAM_PROCESSFILEBINARY, "STREAM_PROCESSFILEBINARY"},
        {STREAM_PROCESSFILEINFO_ALL, "STREAM_PROCESSFILEINFO_ALL"},
        {STREAM_PROCESSFILEBINARY_ALL, "STREAM_PROCESSFILEBINARY_ALL"},
